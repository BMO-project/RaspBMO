...
def checkHitBall(ball, paddle1, paddle2, ballDirX):
    if ballDirX == -1 and paddle1.right == ball.left and paddle1.top+3 < ball.top and paddle1.bottom+3 > ball.bottom:
        return -1
    elif ballDirX == 1 and paddle2.left == ball.right and paddle2.top+3 < ball.top and paddle2.bottom+3 > ball.bottom:
        return -1
    else: return 1
